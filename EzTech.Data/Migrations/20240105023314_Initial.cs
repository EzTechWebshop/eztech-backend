        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageRating = table.Column<decimal>(type: "decimal(14,2)", precision: 14, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Cvr = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Instagram = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TrustPilot = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Website = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WebsiteMessage = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FooterInfo = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpeningHours", x => new { x.WebsiteInfoId, x.Id });
                    table.ForeignKey(
                        name: "FK_OpeningHours_WebsiteInfos_WebsiteInfoId",
                        column: x => x.WebsiteInfoId,
                        principalTable: "WebsiteInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpeningHoursSpecial", x => new { x.WebsiteInfoId, x.Id });
                    table.ForeignKey(
                        name: "FK_OpeningHoursSpecial_WebsiteInfos_WebsiteInfoId",
                        column: x => x.WebsiteInfoId,
                        principalTable: "WebsiteInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebsiteInfoText", x => new { x.WebsiteInfoId, x.Id });
                    table.ForeignKey(
                        name: "FK_WebsiteInfoText_WebsiteInfos_WebsiteInfoId",
                        column: x => x.WebsiteInfoId,
                        principalTable: "WebsiteInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
